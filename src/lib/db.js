    ...
    try {
      ...
      if (prodCount[0].count === 0) {
        const defaultProducts = [
          ...
          ['Bình Gas Luxen Gas 12kg (Xám)', 'binh-gas-luxen-gas-12kg-xam', 'Dịch vụ giao gas nhanh tại Dĩ An & VietSing. Bình gas Luxen Gas 12kg vỏ xám tiêu chuẩn, an toàn PCCC.', 'Dịch vụ giao gas nhanh tại Dĩ An & VietSing. Bình gas Luxen Gas 12kg vỏ xám tiêu chuẩn, an toàn PCCC.', 415000, 390000, '/images/luxen-gas.png', 1, 1],
          ...
          ['Bình Gas Luxen Gas 45kg (Xám)', 'binh-gas-luxen-gas-45kg-xam', 'Dịch vụ giao gas nhanh tại KCN VSIP 1, Dĩ An & Thuận An. Bình gas công nghiệp Luxen 45kg màu xám tiêu chuẩn.', 'Dịch vụ giao gas nhanh tại KCN VSIP 1, Dĩ An & Thuận An. Bình gas công nghiệp Luxen 45kg màu xám tiêu chuẩn.', 1540000, 1440000, '/images/luxen-45.png', 1, 1]
        ];
