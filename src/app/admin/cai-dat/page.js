...
export default function AdminSettingsPage() {
  ...
  const [settings, setSettings] = useState({
    ...
    hero_title_text: 'CÔNG TY CỔ PHẦN NĂNG LƯỢNG XANH ĐẢO NGỌC',
    ...
    about_hero_desc: 'Hành trình xây dựng thương hiệu gas uy tín, an toàn và tận tâm hàng đầu tại TP. HCM (Bình Dương cũ).',
    about_history_title: 'Lịch Sử Hình Thành',
    about_history: 'Ngọc Gas được thành lập từ những năm đầu khi TP. HCM bắt đầu phát triển mạnh mẽ về hạ tầng và dịch vụ. Trải qua hơn 10 năm hoạt động và phát triển, chúng tôi tự hào là đơn vị cung cấp gas uy tín và hệ thống gas công nghiệp đạt chuẩn an toàn phòng cháy chữa cháy hàng đầu tại TP. HCM & Bình Dương.',
    ...
    about_vision: 'Trở thành thương hiệu cung cấp sản phẩm gas và giải pháp thi công hệ thống gas dẫn đầu tại TP. HCM & Bình Dương, được khách hàng lựa chọn hàng đầu nhờ sự uy tín, chuyên nghiệp và tiêu chuẩn an toàn cao nhất.',
    ...
    about_value_2_desc: 'Luôn đặt lợi ích và sự an tâm của khách hàng lên hàng đầu. Phục vụ chu đáo, hỗ trợ kịp thời 24/7.',
