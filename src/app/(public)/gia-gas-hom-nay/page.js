          ...
          <div className="container">
            <div className="seo-article-card">
              ...
              <h2 className="seo-article-main-title">
                {settings.gas_price_seo_title || 'Báo Cáo Xu Hướng Giá Gas Tháng 8/2026'}
              </h2>
              <div 
                className="seo-article-content-body"
                dangerouslySetInnerHTML={{ 
                  __html: (settings.gas_price_seo_content && settings.gas_price_seo_content.length > 200) ? settings.gas_price_seo_content : `<h2>1. Tóm Tắt Nhanh Thị Trường Giá Gas Hôm Nay</h2>
<ul>
