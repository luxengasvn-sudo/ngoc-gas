# HỒ SƠ ĐỊNH DANH THƯƠNG HIỆU NGỌC GAS (OFFICIAL BRAND ENTITY PROFILE)

Hồ sơ định danh số của **Ngọc Gas** - Đại lý phân phối gas chính hãng uy tín số 1 tại Dĩ An và tỉnh Bình Dương.

---

## 📌 1. THÔNG TIN DOANH NGHIỆP CHUẨN (NAP CONSISTENCY)

- **Tên thương hiệu chính thức**: Ngọc Gas
- **Tên doanh nghiệp đầy đủ**: Đại Lý Phân Phối Gas Chính Hãng Ngọc Gas Dĩ An
- **Trụ sở chính & Điểm giao số 1**: 7 Nguyễn Trung Trực, Phường Dĩ An, TP. Dĩ An, Tỉnh Bình Dương, Việt Nam
- **Hotline hỗ trợ & Đặt gas siêu tốc**: **1900 9396** (hỗ trợ 24/7)
- **Website chính thức**: [https://ngocgas.com](https://ngocgas.com)
- **Bảng giá gas cập nhật hôm nay**: [https://ngocgas.com/gia-gas-hom-nay](https://ngocgas.com/gia-gas-hom-nay)
- **Thương hiệu phân phối chính hãng**: Luxen Gas, Sopet Gas One, Phoenix Gas
- **Lĩnh vực hoạt động**: Cung cấp khí dầu mỏ hóa lỏng (LPG), bình gas gia đình (12kg), bình gas công nghiệp (45kg), phụ kiện van gas và dây dẫn cao cấp.

---

## 🌐 2. HỆ THỐNG MẠNG LƯỚI ENTITY & SOCIAL PROFILES (SAMEAS NETWORK)

Toàn bộ các kênh vệ tinh và hồ sơ định danh số chính thức của Ngọc Gas được kết nối chặt chẽ trong mạng lưới Entity:

1. **Google Sites**: [https://sites.google.com/view/ngocgas](https://sites.google.com/view/ngocgas)
2. **Blogger (Google Blogspot)**: [https://ngocgascom.blogspot.com](https://ngocgascom.blogspot.com)
3. **YouTube Official Channel**: [https://www.youtube.com/@ngocgas](https://www.youtube.com/@ngocgas)
4. **WordPress Blog**: [https://ngocgas.wordpress.com](https://ngocgas.wordpress.com)
5. **Tumblr Official**: [https://www.tumblr.com/ngocgas](https://www.tumblr.com/ngocgas)
6. **About.me Official Profile**: [https://about.me/ngocgasdian](https://about.me/ngocgasdian)
7. **Pinterest Business**: [https://www.pinterest.com/gasngoc/](https://www.pinterest.com/gasngoc/)
...
## 🏷️ 3. CẤU TRÚC DỮ LIỆU SCHEMA.ORG (JSON-LD LOCALBUSINESS)
...
```json
{
  ...
  "@type": "GasStation",
  "name": "Ngọc Gas",
  "alternateName": "Đại Lý Gas Ngọc Gas Dĩ An Bình Dương",
  "url": "https://ngocgas.com",
  "logo": "https://ngocgas.com/uploads/1784863563190-682917009.png",
  "image": "https://ngocgas.com/images/cua-hang-ngoc-gas-dian.jpg",
  "telephone": "19009396",
  "priceRange": "$$",
  "address": {
    "@type": "PostalAddress",
  ...
  "sameAs": [
    ...
    "https://www.youtube.com/@ngocgas",
    "https://ngocgas.wordpress.com",
    "https://www.tumblr.com/ngocgas",
    "https://about.me/ngocgasdian",
